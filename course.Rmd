...
This repository is dedicated to presenting my technical course work as a mathematics student at UAF.
...
This course provided a broad overview of basic programming structures and best practices. Topics included 
...
finding methods, and various combinatorial functions(Bell, Stirling, Combination, Permutation, K-list) with support for variable precision arithmetic through the [GMP library](https://gmplib.org/).
